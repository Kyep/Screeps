module.exports = {
    process: function(spawner, partlist, roletext, sourcetext, targettext, thecost, homesector, target_x, target_y, vernum, renew_allowed){
        ...
        var result = spawner.createCreep(partlist, roletext + Game.time.toString(), 
