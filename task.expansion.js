    ...
    process: function(){
        ...
        for(var rname in empire) {
            if(rooms_to_claim[rname] != undefined) {
                // Memory['sectors_under_attack'] = {'W53S12': {'expansionsource': '59bbc3f72052a716c3ce7275', 'controllerid': '59bbc3f72052a716c3ce7274', 'gcltarget': 4 }}
                ...
                } else if (controllertarget.owner['username'] != overlord) {
                ...
                for (var key in Game.spawns) {
                    if (Game.spawns[key].room.name == rname) {
                        ...
                        empire[rname].spawn_from = spawner_name;
                    }
                }
            ...
            if (rmem == 0) {
                // There is nothing to do at level 0. Just promote the room to level 1.
                ...
                if (controller_level >= 3) {
                    //console.log(rname + ': 2->3a');
                     // +5 extensions, +1 tower, build ramparts after tower.
                    ...
                    //console.log(rname + ': 2->3b: ' + extflags.length);
                    ...
                    //console.log(rname + ': 2->3c ' + towerflags.length);
                    ...
                    //console.log(rname + ': 2->3d ' + rampartflags.length);
                    ...
                    //console.log(rname + ': 2->3e ' + roadflags.length);
